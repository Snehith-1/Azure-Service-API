...
@Component({
  selector: 'app-smr-trn-customer-distributor',
  templateUrl: './smr-trn-customer-distributor.component.html',
  styleUrls: ['./smr-trn-customer-distributor.component.scss']
})
export class SmrTrnCustomerDistributorComponent {
  file!: File;
...
GetSmrTrnDistributorSummary() {
  var url = 'SmrTrnCustomerSummary/GetSmrTrnDistributorSummary'
