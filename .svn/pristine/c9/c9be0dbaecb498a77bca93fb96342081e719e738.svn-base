...
@Component({
  selector: 'app-crm-smm-shopifycustomerunassigned',
  templateUrl: './crm-smm-shopifycustomerunassigned.component.html',
  styleUrls: ['./crm-smm-shopifycustomerunassigned.component.scss']
})
export class CrmSmmShopifycustomerunassignedComponent {
...
customer_count: any;
  ...
  //    console.log(this.shopifycustomer_list)
    ...
    this.shopify_customerlist = this.responsedata.shopifycustomersunassigned_list;
