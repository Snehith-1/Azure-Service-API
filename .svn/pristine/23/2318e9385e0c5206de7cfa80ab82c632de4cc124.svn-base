...
@Component({
  selector: 'app-crm-trn-completed',
  templateUrl: './crm-trn-completed.component.html',
  styleUrls: ['./crm-trn-completed.component.scss']
})

export class CrmTrnCompletedComponent {
  parameterValue: any;
  responsedata: any;
  parameterValue1: any;
  myleadslist: any[] = [];
