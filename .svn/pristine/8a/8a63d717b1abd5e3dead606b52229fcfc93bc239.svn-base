...
@Component({
  selector: 'app-crm-trn-mtd',
  templateUrl: './crm-trn-mtd.component.html',
  styleUrls: ['./crm-trn-mtd.component.scss']
})
export class CrmTrnMtdComponent {
...
GetMTD(){
  this.NgxSpinnerService.show();
    var url = 'MarketingManager/GetMTD'
    this.service.get(url).subscribe((result: any) => {
