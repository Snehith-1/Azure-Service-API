...
export class SmrTrnRaiseproposalComponent {
  ...
  constructor(private renderer: Renderer2, private el: ElementRef, public service: SocketService, private ToastrService: ToastrService, private router: Router, private route: ActivatedRoute) {
