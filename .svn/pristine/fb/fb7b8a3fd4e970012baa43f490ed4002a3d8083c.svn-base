...
@Component({
  selector: 'app-crm-trn-dropleads',
  templateUrl: './crm-trn-dropleads.component.html',
  styleUrls: ['./crm-trn-dropleads.component.scss']
})

export class CrmTrnDropleadsComponent {
  parameterValue: any;
  responsedata: any;
  parameterValue1: any;
  myleadslist: any[] = [];
