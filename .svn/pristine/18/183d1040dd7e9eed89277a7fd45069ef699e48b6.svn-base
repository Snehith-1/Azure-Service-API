    ...
    public class DaPmrTrnOpeningInvoice
    {
        ...
        public void DaGetOnChangeCurrency(string currencyexchange_gid, MdlPmrTrnOpeningInvoice values)
        {
            try
            {
                ...
                {
                    values.exchange_rate = objMySqlDataReader["exchange_rate"].ToString();
                    values.currency_code = objMySqlDataReader["currency_code"].ToString();
        ...
        public void DaPostOpeningIvoicedtl(OpeningIvoicedtl values)
        {
            try
            {
                ...
                {
                    lsinvoice_refno = objMySqlDataReader["invoice_refno"].ToString();
                }
