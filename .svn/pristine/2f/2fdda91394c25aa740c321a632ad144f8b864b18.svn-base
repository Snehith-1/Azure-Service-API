...
Public Class crm_trn_opendc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "print.crm_trn_opendc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrm_trn_opendc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crm_trn_opendc = New crm_trn_opendc()
        rpt.Site = Me.Site
        Return rpt
    End Function
