...
@Component({
  selector: 'app-smr-trn-myenquiry',
  templateUrl: './smr-trn-myenquiry.component.html',
  styleUrls: ['./smr-trn-myenquiry.component.scss']
})
export class SmrTrnMyenquiryComponent {
  new_list: any;
  MyTodayTaskCount_List :any;
  MyUpcomingTaskCount_List  :any;
