    ...
    public class DaManageEmployee
    {
        ...
        public bool DaEmployeeProfileView(employee objemployee, string employee_gid)
        {
            try
            {
                ...
                if (objMySqlDataReader.HasRows == true)
                {
                    ...
                    objemployee.personal_emailid = objMySqlDataReader["employee_emailid"].ToString();
                    if (objMySqlDataReader["joiningdate"].ToString() != "")
                    {
                        objemployee.joiningdate = Convert.ToDateTime(objMySqlDataReader["joiningdate"].ToString());
                    }
                }
        ...
        public void DaGetEmployeename(string user_gid, employee_list values)
        {
            ...
            try
            {
                ...
                msSQL = " select concat(user_firstname,' ',user_lastname,' / ',user_code) As Name from adm_mst_tuser  " +
