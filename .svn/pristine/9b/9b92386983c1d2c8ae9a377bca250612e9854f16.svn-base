...
export class SmrTrnCustomerenquirySummaryComponent {
  ...
  constructor(private formBuilder: FormBuilder,private router:Router, private ToastrService: ToastrService, public service: SocketService,public NgxSpinnerService:NgxSpinnerService, private route: ActivatedRoute) {
