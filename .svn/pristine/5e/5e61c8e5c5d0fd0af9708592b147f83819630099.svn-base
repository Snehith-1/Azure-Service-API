    ...
    public class DaInstagram
    {
        ...
        public void DaGetInstagram(instagramlist values)
        {
            try
            {
                ...
                if (objMySqlDataReader.HasRows)
                {
                    ...
                    values.instagram_type = objMySqlDataReader["instagram_type"].ToString();
                    values.username = objMySqlDataReader["user_name"].ToString();
                }
        ...
        public instagramconfiguration instagramcredentials()
        {
            ...
            if (objMySqlDataReader.HasRows == true)
            {
                ...
                getinstagramcredentials.access_token = objMySqlDataReader["access_token"].ToString();
