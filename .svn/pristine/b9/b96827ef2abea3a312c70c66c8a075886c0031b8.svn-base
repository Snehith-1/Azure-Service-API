    ...
    public class DaSmrTrnCustomerSummary
    {
        ...
        public void DaGetSmrTrnCustomerSummary(MdlSmrTrnCustomerSummary values)
        {
            try {
                ...
                " case when a.region_name is null then concat(a.customer_city,' / ',a.customer_state)" +
                " when a.region_name is not null " +
                " then Concat(a.region_name,' / ',a.customer_city,' / ',a.customer_state) end as region_name , a.customer_type, " +
