...
@Component({
  selector: 'app-crm-trn-newmarketing',
  templateUrl: './crm-trn-newmarketing.component.html',
  styleUrls: ['./crm-trn-newmarketing.component.scss']
})
export class CrmTrnNewmarketingComponent {
  responsedata: any;
  New: any;
  remarks: any;
...
//// Summary Grid//////
GetNewManagerSummary() {
  this.NgxSpinnerService.show();
  var url = 'Marketingmanager/GetNewManagerSummary'
  this.service.get(url).subscribe((result: any) => {
    $('#Prospect').DataTable().destroy();
    this.responsedata = result;
    this.New = this.responsedata.New;
