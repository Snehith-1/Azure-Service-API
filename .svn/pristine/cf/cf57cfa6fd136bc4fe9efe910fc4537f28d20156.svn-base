                ...
                if (httpRequest.Files.Count > 0)
                {
...

                    {
                        ...
                        if (objMySqlDataReader.HasRows == true)
                        {
                            ...
                            ls_server = objMySqlDataReader["pop_server"].ToString();

                            ls_port = Convert.ToInt32(objMySqlDataReader["pop_port"]);

                            ls_username = objMySqlDataReader["pop_username"].ToString();

                            ls_password = objMySqlDataReader["pop_password"].ToString();
...

        {
            ...
            try
            {
                ...
                if (objMySqlDataReader.HasRows)
                {
                    ...
                    string ls_server = objMySqlDataReader["pop_server"].ToString();
                    int ls_port = Convert.ToInt32(objMySqlDataReader["pop_port"]);
                    string ls_username = objMySqlDataReader["pop_username"].ToString();
                    string ls_password = objMySqlDataReader["pop_password"].ToString();
