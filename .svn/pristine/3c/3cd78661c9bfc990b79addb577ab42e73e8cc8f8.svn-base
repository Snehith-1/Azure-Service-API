...
export class CrmTrnLeadmasteraddComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reactiveForm = new FormGroup({
      leadbankcontact_name: new FormControl(this.leadmaster.leadbankcontact_name, [
       ...
       customer_type: new FormControl(this.leadmaster.customer_type, [
  ...
  public validate(): void {
    ...
    if (this.leadmaster.active_flag != null && this.leadmaster.leadbank_name != null && this.leadmaster.customer_type != null) {
