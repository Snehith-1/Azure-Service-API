...
export class CrmMstCampaignsummaryComponent {
  ...
  public onsubmit(): void {
    if (this.reactiveForm.value.team_name != null && this.reactiveForm.value.branch != null && this.reactiveForm.value.team_manager != null && this.reactiveForm.value.mail_id != null) {
