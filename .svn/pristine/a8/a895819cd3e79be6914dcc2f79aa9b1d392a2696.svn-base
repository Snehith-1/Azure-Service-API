...
@Component({
  selector: 'app-rbl-trn-invoiceadd-boba',
  templateUrl: './rbl-trn-invoiceadd-boba.component.html',
  styleUrls: ['./rbl-trn-invoiceadd-boba.component.scss']
})

export class RblTrnInvoiceaddBobaComponent {
