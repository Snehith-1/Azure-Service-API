...
@Component({
  selector: 'app-smr-trn-prospect',
  templateUrl: './smr-trn-prospect.component.html',
  styleUrls: ['./smr-trn-prospect.component.scss']
})
export class SmrTrnProspectComponent {
  new_list: any;
  ...
  constructor(private formBuilder: FormBuilder, private ToastrService: ToastrService, private router: ActivatedRoute, private route: Router, public service: SocketService,public NgxSpinnerService :NgxSpinnerService) {
    this.task = {} as ITask;
