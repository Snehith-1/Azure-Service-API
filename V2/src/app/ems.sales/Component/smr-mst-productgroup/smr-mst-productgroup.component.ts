...
export class SmrMstProductgroupComponent {
  ...
  product!: product;
  addtax: any;
  constructor(private formBuilder: FormBuilder, private ToastrService: ToastrService,  public service: SocketService, private router: ActivatedRoute ,public NgxSpinnerService:NgxSpinnerService, ) {
