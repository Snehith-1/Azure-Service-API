...
@Component({
  selector: 'app-crm-trn-prospects',
  templateUrl: './crm-trn-prospects.component.html',
  styleUrls: ['./crm-trn-prospects.component.scss']
})

export class CrmTrnProspectsComponent {
  parameterValue: any;
  responsedata: any;
  parameterValue1: any;
  myleadslist: any[] = [];
