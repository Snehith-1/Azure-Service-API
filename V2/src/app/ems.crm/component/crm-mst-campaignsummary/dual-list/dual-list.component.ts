...
export class DualListComponent implements DoCheck, OnChanges {
	...
	static DEFAULT_FORMAT = { add: 'UnAssigned Employees', remove: 'Assigned Employees', all: 'All Select', none: 'All Unselect', direction: DualListComponent.LTR, draggable: true };
