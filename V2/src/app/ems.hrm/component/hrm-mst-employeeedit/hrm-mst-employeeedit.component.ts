...
export class HrmMstEmployeeeditComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reactiveForm = new FormGroup({
      ...
      empjoiningdate: new FormControl(this.employee.empjoiningdate, [Validators.required]),
      boimetricid: new FormControl(this.employee.boimetricid, [Validators.required]),
      ...
      password: new FormControl(this.employee.password, [Validators.required, Validators.minLength(1)]),
      mobileno: new FormControl(this.employee.mobileno, [Validators.required, Validators.maxLength(10)]),
      comp_email: new FormControl('', [Validators.required, Validators.minLength(1), Validators.maxLength(250), Validators.pattern('^([a-z0-9]+(?:[-.][a-z0-9]+)*)@([a-z0-9]+\\.[a-z]{2,20}(\\.[a-z]{2})?|\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\]|localhost)$')]),
  ...
  GetEditEmployeeSummary(employee_gid: any) {
    ...
    this.service.getparams(url, param).subscribe((result: any) => {
      ...
      this.reactiveForm.get("empjoiningdate")?.setValue(this.employeeedit_list[0].employee_joiningdate);
      ...
      this.reactiveForm.get("reportingto")?.setValue(this.employeeedit_list[0].employee_name);
      ...
      this.reactiveForm.get("tagid")?.setValue(this.employeeedit_list[0].biometric_id);
      this.reactiveForm.get("holidaygrade")?.setValue(this.employeeedit_list[0].holidaygrade);
      ...
      this.reactiveForm.get("permanent_address2")?.setValue(this.employeeedit_list[0].permanent_address2);
      this.reactiveForm.get("permanent_city")?.setValue(this.employeeedit_list[0].permanent_city);
      this.reactiveForm.get("permanent_postal")?.setValue(this.employeeedit_list[0].permanent_postal);
      this.reactiveForm.get("permanent_state")?.setValue(this.employeeedit_list[0].permanent_state);
      this.reactiveForm.get("country")?.setValue(this.employeeedit_list[0].permanent_country);
      this.reactiveForm.get("temporary_address1")?.setValue(this.employeeedit_list[0].temporary_address1);
      this.reactiveForm.get("temporary_address2")?.setValue(this.employeeedit_list[0].temporary_address2);
      this.reactiveForm.get("temporary_city")?.setValue(this.employeeedit_list[0].temporary_city);
      this.reactiveForm.get("temporary_postal")?.setValue(this.employeeedit_list[0].temporary_postal);
      this.reactiveForm.get("temporary_state")?.setValue(this.employeeedit_list[0].temporary_state);
    });
  }
  onChange2(event: any) {
  ...
  public validate(): void {
    ...
    if (this.employee.entityname != null && this.employee.branchname != null && this.employee.departmentname != null && this.employee.designationname != null && this.employee.first_name != null && this.employee.active_flag != null && this.employee.email != null && this.employee.mobile != null) {
      ...
      if (this.file != null && this.file != undefined) {
        ...
        var api = 'HrmTrnAdmincontrol/UpdateEmployeeProfileUpload'
        //console.log(this.file)
