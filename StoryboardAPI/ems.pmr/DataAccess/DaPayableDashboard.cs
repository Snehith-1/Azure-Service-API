        ...
        public void DaGetPayablesummary(payable_tile values)
        {
            try
            {
                ...
                if (objMySqlDataReader != null)
                {
                    ...
                    values.cancel_invoice = objMySqlDataReader["cancel_invoice"].ToString();
                    values.pending_count = objMySqlDataReader["pending_count"].ToString();
                ...
                {
                    objMySqlDataReader.Read();
                    values.vendor_count = objMySqlDataReader["vendor_count"].ToString();
                    objMySqlDataReader.Close();
                }
