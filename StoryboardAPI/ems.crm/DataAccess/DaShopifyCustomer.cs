        ...
        public void DaGetLeadmoved(string user_gid, shopifycustomermovingtolead values)
        {
            try
            {
                ...
                for (int i = 0; i < values.shopifycustomers_lists.ToArray().Length; i++)
                {
                    ...
                    if (dt_datatable.Rows.Count == 0)
                    {
                        ...
                        if (objMySqlDataReader.HasRows)
                        {
                            lssource_name = objMySqlDataReader["source_gid"].ToString();
                        }
                      ...
                      " '" + values.shopifycustomers_lists[i].default_city + "'," +
                        ...
                        if (mnResult1 != 0)
                        {
                            ...
                            if (objMySqlDataReader.HasRows)
                            {
                                string leadbankcontact_name = objMySqlDataReader["leadbankcontact_name"].ToString();
                            ...
                            if (objMySqlDataReader.HasRows)
                            {
                                lscurrencyexchange_gid = objMySqlDataReader["currencyexchange_gid"].ToString();
           ...
           " '" + values.shopifycustomers_lists[i].default_address2 + "'," +
                    ...
                    "'" + DateTime.Now.ToString("yyyy-MM-dd") + "')";
                        ...
                        if (objMySqlDataReader.HasRows)
                        {
                            lscountrygid = objMySqlDataReader["country_gid"].ToString();
            ...
            try {
                ...
                for (int i = 0; i < values.shopifyorderlists.ToArray().Length; i++)
                {
                    ...
                    if (dt_datatable.Rows.Count == 0)
                    {
                        ...
                        if (objMySqlDataReader.HasRows)
                        {
                            lssalesorder_date = objMySqlDataReader["salesorder_date"].ToString();
                            lscustomer_gid = objMySqlDataReader["customer_gid"].ToString();
                            lsaddon_charge = objMySqlDataReader["addon_charge"].ToString();
                            lscurrency_code = objMySqlDataReader["currency_code"].ToString();
                            lscustomer_mobile = objMySqlDataReader["customer_mobile"].ToString();
                            lscustomer_email = objMySqlDataReader["customer_email"].ToString();
                        }
                            ...
                            if (dt_datatable.Rows.Count != 0)
                            {
                                foreach (DataRow dt in dt_datatable.Rows)
                                {
                                 ...
                                 " '" + dt.ItemArray[9] + "')";
                                    ...
                                    if (objMySqlDataReader.HasRows)
                                    {
                                        lstotal_amount = objMySqlDataReader["total_amount"].ToString();
                            ...
                            if (dt_datatable.Rows.Count != 0)
                            {
                                foreach (DataRow dt in dt_datatable.Rows)
                                {
                                    ...
                                    if (mnResult != 0)
                                    {
                                        ...
                                        if (objMySqlDataReader.HasRows)
                                        {
                                            lstotal_invoice = objMySqlDataReader["total_invoice"].ToString();
            ...
            try
            {
                ...
                for (int i = 0; i < values.shopifyinventorystocksendlist.ToArray().Length; i++)
                {
                    ...
                    if (dt_datatable.Rows.Count == 0)
                    {
                        ...
                        if (objMySqlDataReader.HasRows)
                        {
                            lscreated_date = objMySqlDataReader["created_date"].ToString();
