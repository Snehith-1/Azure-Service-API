        ...
        public string DaGetLinkedinProfile(string user_gid)
        {
            ...
            try
            {
                ...
                if (responseAddress.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    {
                        lsprofile_picture = objMySqlDataReader["upload_path"].ToString();
        ...
        public string DaGetLinkedinUser()
        {
            ...
            try
            {
                ...
                if (responseAddress.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    if (objMySqlDataReader.HasRows)
                    {
                        lsuser_name = objMySqlDataReader["user_name"].ToString();
        ...
        public linkedinconfiguration linkedincredentials()
        {
            ...
            try
            {
                ...
                if (objMySqlDataReader.HasRows == true)
                {
                    ...
                    getlinkedincredentials.access_token = objMySqlDataReader["access_token"].ToString();
