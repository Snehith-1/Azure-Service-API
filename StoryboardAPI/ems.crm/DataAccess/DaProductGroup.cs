    ...
    public class DaProductGroup
    {
...

        {
            ...
            try
            {
                ...
                msSQL = " select productgroup_gid,productgroup_name from pmr_mst_tproductgroup where productgroup_name = '" + values.productgroup_nameedit + "'";
                objMySqlDataReader = objdbconn.GetDataReader(msSQL);
                ...
                if (objMySqlDataReader.HasRows)
                {
                    ...
                    lsproductgroup_name = objMySqlDataReader["productgroup_name"].ToString();
                }
                ...
                {
                    if (string.Equals(lsproductgroup_name, values.productgroup_nameedit, StringComparison.OrdinalIgnoreCase))
                    {
                        values.status = false;
