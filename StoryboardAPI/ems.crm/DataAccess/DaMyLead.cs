    ...
    public class DaMyLead
    {
...

        {
            ...
            try
            {
                ...
                msSQL = " Select b.leadbank_name, b.customer_type, k.campaign_title,i.schedule_status, i.schedule_type,i.schedule_remarks,i.schedulelog_gid," +
        ...
        public void DaGetTodaySummary(MdlMyLead values, string employee_gid)
        {
            try
            {
                ...
                msSQL = " select f.assign_to,b.customer_type,a.log_gid,a.schedulelog_gid,b.leadbank_gid,f.lead2campaign_gid,a.schedule_remarks,a.schedule_status, " +
        ...
        public void DaGetNewSummary(string employee_gid, MdlMyLead values)
        {
            ...
            try
            {
                ...
                msSQL = " select b.leadbank_name, b.customer_type,k.campaign_title,b.customer_type, g.mobile  ," +
              " concat(g.leadbankcontact_name,' / ',g.mobile,' / ',g.email) as contact_details," +
        ...
        public void DaGetCustomerSummary(MdlMyLead values, string employee_gid)
        {
            ...
            try
            {
                ...
                msSQL = " Select b.leadbank_name, k.campaign_title, i.schedule_type,b.customer_type,b.leadbank_gid,a.call_count, g.mobile  ," +
               " concat(g.leadbankcontact_name,' / ',g.mobile,' / ',g.email) as contact_details," +
               " concat(d.region_name,'/',b.leadbank_city,'/',b.leadbank_state,'/',h.source_name) as region_name," +
               " (b.remarks) as internal_notes,cast(concat(i.schedule_date,' ', i.schedule_time) as datetime) as schedule," +
               " z.leadstage_name,a.lead2campaign_gid, a.leadbank_gid, a.campaign_gid, g.leadbankcontact_gid" +
        ...
        public void DaGetDropSummary(MdlMyLead values, string employee_gid)
        {
            ...
            try
            {
                ...
                msSQL = "Select  b.leadbank_name,k.campaign_title,a.assign_to,b.customer_type,b.leadbank_gid,a.call_count," +
               "concat(g.leadbankcontact_name,' / ',g.mobile,' / ',g.email) as contact_details, " +
               "concat(d.region_name,'/',b.leadbank_city,'/',b.leadbank_state,'/',h.source_name) as region_name, " +
               "(b.remarks) as internal_notes, z.leadstage_name, " +
        ...
        public void DaGetcallresponsedropdown(MdlMyLead values)
        {
            ...
            try
            {
                ...
                msSQL = "select call_response,callresponse_gid,moving_stage,callresponse_code from crm_mst_callresponse";
                dt_datatable = objdbconn.GetDataTable(msSQL);
