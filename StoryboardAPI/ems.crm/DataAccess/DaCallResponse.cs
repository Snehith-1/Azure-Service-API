    ...
    public class DaCallResponse
    {
...

        {
            ...
            try
            {
                ...
                {
                    lscallresponse_gid = objMySqlDataReader["callresponse_gid"].ToString();
                    lscall_response = objMySqlDataReader["call_response"].ToString();
                }
                ...
                if (lscallresponse_gid == values.callresponse_gid)
                {
                    ...
                    else
                    {
                        ...
                        if (objMySqlDataReader.HasRows)
                        {
                            lsleadstage_gid = objMySqlDataReader["leadstage_gid"].ToString();
