...
namespace ems.utilities.Functions
{
    public class cmnfunctions
    {
        ...
        public void sendMessage(string number, string message)
        {
            ...
            {
                INSTANCE_ID = objMySqlDataReader["whatsapp_instance_id"].ToString();
                CLIENT_ID = objMySqlDataReader["whatsapp_client_id"].ToString();
                CLIENT_SECRET = objMySqlDataReader["whatsapp_client_secret"].ToString();
