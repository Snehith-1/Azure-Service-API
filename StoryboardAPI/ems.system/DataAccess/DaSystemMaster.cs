    ...
    public class DaSystemMaster
    {
        ...
        public void DaGetMenuMappingEdit(string menu_gid, menu values)
        {
            try
            {
                ...
                {
                    values.menu_gid = objMySqlDataReader["menu_gid"].ToString();
                    values.module_gid_parent = objMySqlDataReader["module_gid_parent"].ToString();
                    values.module_gid = objMySqlDataReader["module_gid"].ToString();
                    values.module_name = objMySqlDataReader["module_name"].ToString();
